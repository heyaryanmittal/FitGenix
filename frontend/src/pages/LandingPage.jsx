...
const LandingPage = () => {
    ...
    const features = [
        {
            title: "Adaptive AI Workout Split",
            description: "Custom routines generated based on your muscle split, available equipment, and weekly time constraints.",
            icon: <Dumbbell className="w-6 h-6 text-orange-600" />,
            badge: "AI DYNAMIC"
        },
        {
            title: "Precision Macro & Food Tracker",
            description: "Instant calorie & macro breakdowns for Indian & global cuisines with custom serving size recalculation.",
            icon: <Utensils className="w-6 h-6 text-orange-600" />,
            badge: "EXACT MACROS"
        },
        {
            title: "7-Day Smart Meal Planner",
            description: "Complete weekly nutrition schedules generated by AI with 1-click alternative meal swaps.",
            icon: <Calendar className="w-6 h-6 text-orange-600" />,
            badge: "NUTRITION AI"
        },
        {
            title: "24/7 AI Personal Coach",
            description: "Ask any exercise, recovery, or diet question anytime and receive instant expert answers.",
            icon: <Brain className="w-6 h-6 text-orange-600" />,
            badge: "LLAMA 3.3"
        },
        {
            title: "Real-time Danger Sign Alerts",
            description: "Interactive warnings trigger instantly when your calorie or macro targets exceed safe thresholds.",
            icon: <AlertTriangle className="w-6 h-6 text-orange-600" />,
            badge: "SAFETY CORE"
        },
        {
            title: "Interactive Form & Muscle Guide",
            description: "Step-by-step exercise form guides with target muscle group indicators and workout logging.",
    ...
    const pricingPlans = [
        ...
        },
        {
            ...
            price: "₹799",
            period: "per month",
            description: "The complete AI-powered fitness split & nutrition suite.",
            features: [
                "Everything in Starter",
                "Unlimited 7-Day AI Meal Plans",
                "Adaptive AI Workout Split Generator",
                "24/7 AI Fitness Coach Access",
                "Macro Limit Exceeded Safety Alerts",
                "Priority Cloud Telemetry Sync"
            ],
            popular: true,
            ...
            <section id="features" className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto border-t border-slate-200/80">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {features.map((feat, idx) => (
                        <Card key={idx} className="sunrise-card hover:border-orange-400 transition-all group">
                            <CardHeader className="space-y-3">
                                <div className="flex items-center justify-between">
                                    <div className="w-12 h-12 rounded-xl bg-orange-100 border border-orange-200 flex items-center justify-center group-hover:scale-110 transition-transform">
                                        {feat.icon}
                                    </div>
                                    <Badge variant="default">{feat.badge}</Badge>
                                </div>
                                <CardTitle className="text-xl font-extrabold text-slate-900 group-hover:text-orange-600 transition-colors">
                                    {feat.title}
                                </CardTitle>
                            </CardHeader>
                            <CardContent>
